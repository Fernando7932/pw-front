...
const StreamPage: React.FC<StreamPageProps> = ({ username }) => {
  ...
  return (
    <div className="flex flex-col md:flex-row w-full h-[calc(100vh-64px)] overflow-hidden bg-[#0b0e0f]">
      
      {/* columna izquierfda (Video + Info/Regalos) */}
      <div className="flex-1 flex flex-col gap-4 p-4 overflow-y-auto [&::-webkit-scrollbar]:hidden [-ms-overflow-style:none] [scrollbar-width:none]">
      ...
      <div className="w-full md:w-80 h-full flex-shrink-0 bg-[#0b0e0f] border-l border-[#24272c]"> 
